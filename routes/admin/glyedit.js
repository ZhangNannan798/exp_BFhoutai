...
/* GET home page. */
router.get('/glyedit', function (req, res, next) {
    res.render('glyedit');
});
router.post('/glyedit', function (req, res, next) {
        ...
        if (err) {
            ...
            fs.rename(oldPath, newPath, (err) => {
                if (err) {
                    ...
                    db.insertFilm('glylists', data, (ret) => {
                        //   console.log(ret)
                        res.redirect('http://localhost:4001/admin/glylist')
                    })
